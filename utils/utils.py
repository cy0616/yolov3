...
def bbox_iou_old(box1, box2, x1y1x2y2=True):
    """
...
def non_max_suppression_old(prediction, conf_thres=0.5, nms_thres=0.4):
    """
        ...
        for c in unique_labels:
            ...
            if nms_style == 'OR':  # Classical NMS
                while det_class.shape[0]:
                    ...
                    ious = bbox_iou_old(det_max[-1], det_class[1:])
                ...
                while det_class.shape[0]:
                    ...
                    ious = bbox_iou_old(det_class[:1], det_class[1:])
